...
int main()
{
    ...
    state.emptyCol = 0;
    state.emptyRow = 1;
    state.eightPuzzel[0][0] = 2;
    state.eightPuzzel[0][1] = 8;
    state.eightPuzzel[0][2] = 1;
    state.eightPuzzel[1][0] = 0;
    state.eightPuzzel[1][1] = 4;
    state.eightPuzzel[1][2] = 3;
    ...
    goal.emptyCol = 1;
    goal.emptyRow = 1;
    goal.eightPuzzel[0][0] = 1;
    goal.eightPuzzel[0][1] = 2;
    goal.eightPuzzel[0][2] = 3;
    goal.eightPuzzel[1][0] = 8;
    goal.eightPuzzel[1][1] = 0;
    goal.eightPuzzel[1][2] = 4;
